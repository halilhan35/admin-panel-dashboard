...
router.post("/update", async (req, res) => { 
    ...
    try {
        ...
        if(body.permissions && Array.isArray(body.permissions) && body.permissions.length > 0){
            ...
            // body.permissions => ["user_view", "user_add", "user_update"]
            // permissions => [{role_id: "123",permission: "user_view"}, {permission: "user_add", _id: "bcd"}];
...
router.post("/delete", async (req, res) => { 
    ...
    try {
        ...
        await Roles.deleteWithPrivileges(body._id);
